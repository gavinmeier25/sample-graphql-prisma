...
type ComplexityRoot struct {
	Mutation struct {
		...
		Publish     func(childComplexity int, postIds string) int
	}
...
type MutationResolver interface {
	...
	Publish(ctx context.Context, postIds string) (*prisma.Post, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.Publish":
		...
		return e.complexity.Mutation.Publish(childComplexity, args["postIds"].(string)), true
...
func (ec *executionContext) _Mutation_publish(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().Publish(rctx, args["postIds"].(string))
	})
	if resTmp == nil {
		return graphql.Null
	}
